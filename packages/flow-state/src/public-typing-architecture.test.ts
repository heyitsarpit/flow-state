...
describe("public typing architecture", () => {
  ...
  it("keeps server, inspect, and testing types off the root entrypoint", () => {
    ...
    expect(testingSource).toContain("scenarioToReport");
    expect(testingSource).toContain("FlowScenarioReport");
  ...
  it("keeps entrypoints isolated to their owned runtime boundaries", () => {
    ...
    expect(testingSource).toContain("FlowScenarioBlocked");
    expect(testingSource).toContain("FlowScenarioBlockedReason");
    expect(testingSource).toContain("FlowScenarioOutcome");
    expect(testingSource).toContain("FlowScenarioResult");
    expect(testingSource).toContain("FlowScenarioCheck");
    expect(testingSource).toContain("FlowScenarioCheckKind");
    expect(testingSource).toContain("FlowScenarioReport");
    expect(testingSource).not.toContain("FlowStoryRunOutcome");
    expect(testingSource).not.toContain("FlowStoryTestReport");
