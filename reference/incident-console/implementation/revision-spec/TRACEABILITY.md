...
| 2026-08-18 accepted runtime-reactivity amendment   | `REV-OPS-015`, `REV-HOST-007`                            | Accepted amendment   | StoreFanout, actor-scoped previews, projection-only publications, continuing projections, polling, and passive read tracking |
| 2026-08-18 accepted closure amendment              | `REV-OPS-016`–`018`, `REV-HOST-008`, `REV-MIG-005`–`006` | Accepted amendment   | Canonical identity, exact operation states, bounded invalidation, trusted host writes, v2 artifacts/CLI, and child removal   |
...
| `DESIGN_BEHAVIOR_GAPS.md:25-289`                                   | Required behavioral closure beneath accepted surface    | `UNRESOLVED_BEHAVIOR.md`, `REV-TEST-003`, `REV-TEST-005`–`REV-TEST-008`, `REV-OPS-015`–`018`, `REV-HOST-002`–`REV-HOST-008`, `REV-MIG-005`–`006`, `REV-COMP-003`–`REV-COMP-005`, `REV-COMP-012`, `REV-COMP-013`, `REV-COMP-015` | Live register: 33 inherited entries excluding formally resolved `BEH-017`; all 33 are closed by accepted amendments |
...
Passed on 2026-08-18 after the runtime-reactivity, canonical-identity, runtime-bootstrap, Story, operation,
host-write, artifact, CLI, and child-removal amendments. All 68 revision IDs remain present and indexed
exactly once. All 33 inherited behavior entries are closed by `REV-TEST-005`–`REV-TEST-008`,
`REV-OPS-015`–`018`, `REV-HOST-002`–`REV-HOST-008`, `REV-MIG-005`–`006`, `REV-COMP-003`–`REV-COMP-005`,
`REV-COMP-006`, `REV-COMP-008`, `REV-COMP-012`, `REV-COMP-013`, and `REV-COMP-015`; former
`BEH-017` and both former formalization gaps are recorded above and reproduced normatively in their owning
chapters.

### No-invention audit

Passed on 2026-08-16 and refreshed on 2026-08-18. Independent authority-partition and operations reviews
originally withheld compound syntax, constructor option types, and Story-local graph semantics until explicit
acceptance. The formalization review accepted exactly those three answers; the 2026-08-18 amendments then
accepted the exact operation state unions, invalidation bounds, trusted host writes, artifact/CLI model, and
child-removal consequences. Public helper exports and unrelated proposal-only answers remain non-normative;
historical paths occur only in provenance.
...
A follow-up read-only audit after the 2026-08-16 formalization acceptance and the 2026-08-18 amendments
confirmed that the recursive
configuration grammar, conditional Story option types, recipe-or-ref context graph, migration instructions,
resolved-history records, and blocker register agree. It found 68 unique revision owners, zero open and 33
closed `BEH-*` entries, and no stale unresolved reference to either former `SPEC-GAP-*` item or `BEH-017`.
