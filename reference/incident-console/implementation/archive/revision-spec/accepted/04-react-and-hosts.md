...
production `Runtime` or Story fixture owner for one live runtime, one compiled app, and one declared
...
The historical blocker register is recorded in [`UNRESOLVED_BEHAVIOR.md`](../../../revision-spec/UNRESOLVED_BEHAVIOR.md).
...
obligations remain in the proof matrix and executable proof records tracked by Beads.
