...
by [`PUBLIC_API.md` API-005](./PUBLIC_API.md#api-005--resources-separate-executable-input-p-from-canonical-key-k). `KBytes` has no whitespace or trailing newline; the artifact file boundary may add its
