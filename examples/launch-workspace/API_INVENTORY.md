...
| `flow.useResource`        | React shell resource breadcrumb                                                          | Executable provider-backed resource snapshot read with optimistic subscribe reconciliation                                                                                                  | `src/main.tsx`                    |
| `flow.use`                | React shell flow subscription                                                            | Executable provider-backed actor hook with render-safe shell creation, live actor swap, and unmount disposal                                                                                | `src/main.tsx`                    |
| `flow.useView`            | React shell read model                                                                   | Executable explicit projection hook with selector equality and issue-aware updates                                                                                                          | `src/main.tsx`                    |
