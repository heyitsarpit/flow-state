...
`nub run --filter @flow-state/offline-recovery test` runs the deterministic runtime, rehydration,
stream, transaction, trace, scenario, and React proofs. `nub run --filter
