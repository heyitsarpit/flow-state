...
| `flow.orchestrators.test` | Runtime docs            | Test app layer descriptor                                                                | executable registry                                    | Deterministic mailboxes and virtual time are partial.                                             |
...
| `flow.after`              | Streams docs            | Assets completion dismissal                                                              | descriptor-only                                        | Virtual-time firing is contract-only.                                                             |
...
| `flowTest.app`            | Testing docs            | Seeded resources, module fixtures, transactions                                          | executable                                             | `flush` drains only ready queued work; `advance` and bounded `settle` are still contract-only.    |
...
- Virtual time, `flowTest.advance`, and bounded `settle`.
