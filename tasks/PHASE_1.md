...
### P1A.0 Safe definitions and app identity
...
### P1A.4d Prevalidated resource restore
...
### P1B.2 Atomic mutation and notification
...
### P1C.1 Ownership domains

- One OrchestratorSystem registry owns actor incarnations and explicit
  registered, focused-compatibility, inherited-child, and request ownership.
...
### P1C.2 One actor read path

- `getSnapshot()` and compatible `snapshot()` share one side-effect-free
  implementation and exact return type.

### P1C.3a Stop, finalizers, and exact eviction
...
### P1D.1a Host boundary and Layer composition
...
- Exact source and packed types preserve public compatibility and Effect channels.
