...
Status: **Phase 1 is current. No packet is active. P1C.1 is the next packet.**
...
1. P1C.1 — canonical actor owner and ownership domains.

P1A.4d closed prevalidated internal resource restore.
P1C.1 is now the next executable packet.
...
| P1C.1  | **Ready — next** | P1A.0, P1D.1a                        | Canonical actor owner and ownership domains                                      |
