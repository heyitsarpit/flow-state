...
Status: **Phase 1 is current. No packet is active. P1B.1 is the next packet.**
...
1. P1B.1 — canonical ResourceStore and resource identity migration.

P1D.1a closed the remaining ready prerequisite for P1B.1. P1B.1 is now the
...
| P1B.1  | **Ready — next** | P1A.2, P1D.1a                        | Canonical ResourceStore and resource identity migration; includes former P1A.3a  |
